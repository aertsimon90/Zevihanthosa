...
def save(obj):
    ...
    if obj.type == 0:
        ...
        data = {"t": 5, "f": obj.func, "r": obj.range, "rc": obj.rangc, "o": obj.outputs, "md": obj.maxdatac, "m": obj.margin, "pr": obj.procs, "ts": obj.trainstart, "td": obj.traindepth, "n": obj.nums, "en": obj.exnums}
    elif obj.type == 6:
        data = {"t": 6, "w": obj.weights, "b": obj.biases, "l": obj.learning, "pc": obj.pcount, "m": [obj.mw, obj.mb], "tr": obj.truely, "mx": obj.momentumexc, "a": obj.activation.save()}
